...
exports.seed = async knex => {
  ...
  try {
    ...
    await knex('locations').insert([
      {locations_id: uuidv4(), suburb: 'Grey Lynn', postcode: 1021, locations_listing_id: listingsIdsArray[0]},
      {locations_id: uuidv4(), suburb: 'Takapuna', postcode: 0622, locations_user_id: usersIdsArray[1]},
      {locations_id: uuidv4(), suburb: 'Manurewa', postcode: 2102, locations_user_id: usersIdsArray[0]},
      {locations_id: uuidv4(), suburb: 'Kohimarama', postcode: 1071, locations_listing_id: listingsIdsArray[1]},
      {locations_id: uuidv4(), suburb: 'Remuera', postcode: 1050, locations_user_id: usersIdsArray[2]},
      {locations_id: uuidv4(), suburb: 'Ellerslie', postcode: 1051, locations_listing_id: listingsIdsArray[2]}
    ])
    await knex('likes').insert([
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[0], likes_listing_id: listingsIdsArray[0]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[1], likes_listing_id: listingsIdsArray[0]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[2], likes_listing_id: listingsIdsArray[0]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[0], likes_listing_id: listingsIdsArray[1]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[1], likes_listing_id: listingsIdsArray[1]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[2], likes_listing_id: listingsIdsArray[1]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[0], likes_listing_id: listingsIdsArray[2]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[1], likes_listing_id: listingsIdsArray[2]},
      {likes_id: uuidv4(), likes_user_id: usersIdsArray[2], likes_listing_id: listingsIdsArray[2]},
    ])
  } catch (e) {
